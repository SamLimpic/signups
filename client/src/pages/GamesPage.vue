<template>
  <div class="games flex-grow-1 container-fluid align-items-center text-center m-3">
    ...
    <div class="row justify-content-around" v-else>
      <div class="col-xl-8 col-lg-9 col-md-10 col-11 p-sm-3 p-2" v-if="!state.characters[0]">
        <h2 class="font-xxl">
      ...
      <div class="col-12 p-sm-3 p-2" v-else-if="!state.activeCharacter.id">
        <h2 class="font-xxl m-0">
      ...
      <div class="col-12 p-sm-3 p-2" v-else-if="(state.choice + state.removed) <= state.games.length">
        <h2 class="font-xxl m-0">
      ...
      <div class="col-12 p-sm-3 p-2" v-else-if="state.choice === 0">
        <h2 class="font-xxl m-0">
      ...
      <!-- <div class="col-12 p-sm-3 p-2" v-else>
        <h2 class="font-xxl mb-4">
          <u>Confirm your selections to sign up this week!</u>
        </h2>
        <h3><i class="fas fa-dungeon text-warning icon mb-1"></i></h3>
